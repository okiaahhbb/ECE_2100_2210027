...
<head>
  ...
  <title>Booksy - Discover Books</title>
...
<body>
  ...
  <input type="text" class="search" placeholder="Search by title, author..." />
...
<section class="hero-green">
  <div class="hero-text">
    <h1>📘 Want to explore more books?</h1>
    <p>Discover your favorite reads from every department, all in one place.</p>
    <div class="hero-buttons">
      <a href="collection.php" class="hero-animate-btn">Explore Now</a>
      <a href="login.php" class="hero-animate-btn">Login</a>
    </div>
  </div>
  <div class="hero-float-image">
    <img src="Images/svg.svg" alt="Books" />
  </div>
</section>
  ...
  <!-- ===== DEPARTMENT WISE BOOKS (ECE, ME, Civil) ===== -->
...
<div class="book">
  ...
  <section class="popular">
    ...
    <div class="book-grid">
     <div class="book"><img src="Images/Engineering Thermodynamics.jpg" alt=""><h4>Engineering Thermodynamics</h4><p>P.K. Nag | Rajat Kumar</p></div>
      <div class="book"><img src="Images/Strength of Materials.jpg" alt=""><h4>Strength of Materials</h4><p>R.K. Rajput</p></div>
      <div class="book"><img src="Images/Theory of Machines.jpg" alt=""><h4>Theory of Machines</h4><p> S.S. Rattan</p></div>
      <div class="book"><img src="Images/Fluid Mechanics and Hydraulic Machines.jpg" alt=""><h4>Fluid Mechanics and Hydraulic Machines</h4><p>R.K. Bansal</p></div>
      <div class="book"><img src="Images/Mechanical Engineering Design.jpg" alt=""><h4>Mechanical Engineering Design</h4><p>J.E. Shigley | Charles R. Mischke | Richard G. Budynas</p></div>
    </div>
  </section>
  ...
  <p>B.C. Punmia, Ashok Kumar Jain, Arun Kumar Jain</p></div>
